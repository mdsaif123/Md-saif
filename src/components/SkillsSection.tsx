...
const bentoCategories = [
  {
    ...
    items: ['HTML5', 'CSS3', 'JavaScript', 'React.js', 'Next.js', 'Bootstrap', 'Tailwind CSS', 'Material UI'],
    description: 'Building responsive, modern user interfaces with clean component architecture and pixel-perfect design implementation.',
    stat: 'RESPONSIVE UI',
  ...
  },
  {
    ...
    badge: 'SERVER & APIs',
    items: ['Python', 'Node.js', 'Nest.js', 'Express.js'],
    description: 'Designing robust server-side logic, RESTful APIs, and scalable backend architecture for real-world applications.',
    stat: 'API DRIVEN',
  ...
  },
  {
    ...
    badge: 'DATA STORAGE',
    items: ['MongoDB', 'MySQL', 'PostgreSQL', 'Vector DB'],
    description: 'Working with relational and NoSQL databases, along with vector databases for AI & RAG-based applications.',
    stat: 'SQL & NOSQL',
    colSpan: 'lg:col-span-5',
  },
  {
    ...
    items: ['CI/CD', 'GitHub', 'Jira', 'Git'],
    description: 'Managing version control, deployment pipelines, and team collaboration workflows for smooth project delivery.',
    stat: 'TEAM WORKFLOW',
    colSpan: 'lg:col-span-7',
  },
];
