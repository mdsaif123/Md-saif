...
const journey: RouteStop[] = [
  {
    ...
    organization: 'HIGHER STUDIES',
    description: 'Pursuing advanced studies in Computer Science, deepening expertise in software architecture, systems design, and emerging technologies.',
  },
  {
    id: '02',
    year: '2024 - PRESENT',
    title: 'SOFTWARE ENGINEER & FULL STACK DEVELOPER',
    organization: 'PRODUCTION PROJECTS',
    description: 'Working as a Software Engineer and Full Stack Developer, building end-to-end web & mobile applications across multiple domains and industries.',
  },
  {
    id: '03',
    year: '2020 - 2023',
    ...
    organization: 'MUMBAI',
    description: 'Completed Bachelor’s degree in Computer Science from Mumbai, building a strong foundation in programming, algorithms, and software fundamentals.',
  },
  {
    id: '04',
    year: 'ONGOING',
    title: 'ETHICAL HACKER',
    organization: 'CYBERSECURITY & PENTESTING',
    description: 'Exploring and practicing ethical hacking — vulnerability assessment, penetration testing, and security research alongside development work.',
  },
];
