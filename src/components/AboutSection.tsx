        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.div variants={fadeUpVariants} className="relative mb-6 select-none">
              ...
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              I'm <span className="text-[#F3DBB3] font-medium">MD Saif</span>, a Software Engineer and Full Stack Developer with years of hands-on experience building real-world products. I've worked on a wide range of projects — from hotel booking platforms and car rental websites to AI-powered RAG applications and e-commerce stores, and many more. I enjoy turning ideas into dynamic, scalable, and visually engaging web experiences.
            </motion.p>
